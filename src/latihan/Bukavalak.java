...
public class Bukavalak {
    ...
    public static void main(String[] args) {
        ...
        nm_ksr = keyboard.nextLine();
        System.out.print("Masukan nama konsumen : ");
        nm_pmbl = keyboard.nextLine();
        System.out.println("=======================================");
